  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/met-logo.svg" alt="${productName}" border="0" />
        <h1>Welcome to <strong>Aerodrome Warnning Traffic Lights</strong></h1>
      </div>
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            <div class="welcome-primary-link">
              <h3><a href="/keycloak/auth/realms/awtl/account"><img src="welcome-content/user.png">Account Awtl <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
              <div class="description">
                Manage your personal user account for applications with only Awtl users.
              </div>
            </div>
          </div>
