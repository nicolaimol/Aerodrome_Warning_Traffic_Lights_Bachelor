...
const pages = ['Hjem', "Flygeleder", "Pilot", "Bakkemanskap"]; // Legg til alle menu-items her
const links = new Map();
links.set("Hjem", "/")
links.set("Flygeleder", "/flygeleder")
links.set("Pilot", "/pilot")
links.set("Bakkemanskap", "/bakkemanskap")
    ...
    <AppBar position="static" style={{ background: 'white' }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters> {/* Logo for burgermeny */}
          ...
          >
            <Link to={links.get('Hjem')}><img src={MetLogo} alt="Met logo"/></Link>
